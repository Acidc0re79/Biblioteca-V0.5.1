...
$allowed_pages = [
    ...
    // --- Logs ---
    'logs_system'               => __DIR__ . '/views/sistema/logs/system.php',
    'logs_api'                  => __DIR__ . '/views/sistema/logs/api.php',
    'logs_handler'              => __DIR__ . '/views/sistema/logs/handler.php',
    'logs_frontend'             => __DIR__ . '/views/sistema/logs/frontend.php'
];
